...
final class InvoiceRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`invoices`' : '"invoices"';
     ...
     * [ 'invoice_number' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'order_id', 'variable_symbol', 'issue_date', 'due_date', 'subtotal', 'discount_total', 'tax_total', 'total', 'currency', 'qr_data' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $keys = [ 'invoice_number' ];
        $upd  = [ 'order_id', 'variable_symbol', 'issue_date', 'due_date', 'subtotal', 'discount_total', 'tax_total', 'total', 'currency', 'qr_data' ];
