...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'order_id', 'invoice_number', 'variable_symbol', 'issue_date', 'due_date', 'subtotal', 'discount_total', 'tax_total', 'total', 'currency', 'qr_data', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'invoice_number' ], [ 'tenant_id', 'id' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'order_id' ]; }
