...
final class InvoiceDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'order_id' => 'orderId', 'invoice_number' => 'invoiceNumber', 'variable_symbol' => 'variableSymbol', 'issue_date' => 'issueDate', 'due_date' => 'dueDate', 'discount_total' => 'discountTotal', 'tax_total' => 'taxTotal', 'qr_data' => 'qrData', 'created_at' => 'createdAt' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'order_id', 'variable_symbol', 'due_date', 'qr_data' ];
