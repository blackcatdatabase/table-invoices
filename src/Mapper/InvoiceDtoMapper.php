...
namespace BlackCat\Database\Packages\Invoices\Mapper;

use BlackCat\Database\Packages\Invoices\Dto\InvoiceDto;
use BlackCat\Database\Packages\Invoices\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO InvoiceDto:
...
final class InvoiceDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'tenant_id', 'order_id' ];
    /** @var string[] */
    private const FLOAT_COLS  = [ 'subtotal', 'discount_total', 'tax_total', 'total' ];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'issue_date', 'due_date', 'created_at' ];
    /** @var string[] */
     ...
     * @return InvoiceDto
     */
    public static function fromRow(array $row): InvoiceDto
    {
        /** @var InvoiceDto */
    ...
    public static function fromRowOrNull(?array $row): ?InvoiceDto
    {
     ...
     */
    public static function toRow(InvoiceDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(InvoiceDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(InvoiceDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(InvoiceDto $dto): array
    {
        $row = self::toRow($dto);
