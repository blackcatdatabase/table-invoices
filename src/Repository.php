...
use BlackCat\Database\Packages\Invoices\Repository\InvoiceRepository;
...
final class Repository
{
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\Invoices\Dto\InvoiceDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\Invoices\Dto\InvoiceDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\Invoices\Dto\InvoiceDto|null
    {
