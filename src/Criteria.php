 ...
 * - whitelist filtrů: [ 'id', 'order_id', 'invoice_number', 'variable_symbol', 'issue_date', 'due_date', 'subtotal', 'discount_total', 'tax_total', 'total', 'currency', 'qr_data', 'created_at' ]
 * - whitelist pro LIKE hledání: [ 'invoice_number', 'variable_symbol', 'currency', 'qr_data' ]
 */
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'order_id', 'invoice_number', 'variable_symbol', 'issue_date', 'due_date', 'subtotal', 'discount_total', 'tax_total', 'total', 'currency', 'qr_data', 'created_at' ], true);
        ...
        if ($this->search !== null) {
            $searchCols = [ 'invoice_number', 'variable_symbol', 'currency', 'qr_data' ];
            $likeParts = [];
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'order_id', 'invoice_number', 'variable_symbol', 'issue_date', 'due_date', 'subtotal', 'discount_total', 'tax_total', 'total', 'currency', 'qr_data', 'created_at' ], true);
            $parts = [];
