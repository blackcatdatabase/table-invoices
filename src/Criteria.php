...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'tenant_id', 'order_id', 'invoice_number', 'variable_symbol', 'issue_date', 'due_date', 'subtotal', 'discount_total', 'tax_total', 'total', 'currency', 'qr_data', 'created_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\Invoices\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\Invoices\Definitions::softDeleteColumn();
