...
> Lineage: 2 outbound / 1 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 3 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\invoices](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\invoices) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package invoices -Apply
